...
3) alcohol assumption decreases the number of school absences - **absences**
...
* the number of absences has only one peak that is 0-10, so mainly students have less the 10 times of absence
...
```
As it can be seen from the table, my model correctly classified 244+21=265 observations and failed with 90+15= 105 observations, the training error is 105/(265+105) = 0.28.
...
Number of incorrectly classified observations can be estimated as average (training error).
